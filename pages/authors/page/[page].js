...
import authorsPageInitialPaths53714Resource from '../../../resources/authors-page-initial-paths-53714'
import authorsPageInitialPropsFe1f0Resource from '../../../resources/authors-page-initial-props-fe1f0'
...
export async function getStaticPaths() {
  const response = await authorsPageInitialPaths53714Resource({})
...
export async function getStaticProps(context) {
  const response = await authorsPageInitialPropsFe1f0Resource({
    ...context?.params,
